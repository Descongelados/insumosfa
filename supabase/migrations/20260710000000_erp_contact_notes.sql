/*
# Contact Notes — Notas de contacto para Clientes y Prospectos

Crea dos tablas para registrar notas de seguimiento con fecha:
  - erp_client_notes: notas asociadas a un cliente
  - erp_prospect_notes: notas asociadas a un prospecto
*/
